...
def get_morph(element: et.Element, state: State, context: Context, morphs: list[morphs.Morph], ignore_malformed=False) -> State:
    ...
    morph = TAGS[element.tag.lower()](*state_info[:3])
